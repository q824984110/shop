...
<head>
    ...
    <link rel="icon" href="/homes/p1/160614/idid_ifrtgzddgm3dmnjshezdambqhayde_49x48.png" type="image/x-icon"/>

    <script> curl = {apiName: 'require'}; var MOGU = {}; var MoGu = {};</script>



    <link href="/homes/css/index.css-63e7a9a6.css" rel="stylesheet" type="text/css"/>



    <link href="/homes/css/index.css-6b668861.css" rel="stylesheet" type="text/css"/>

    <script type="text/javascript" src="/homes/js/pkg-pc-base.js-beb518b8.js"></script>
...
<div id="body_wrap">
    <div class="mu_wrap wrap clearfix">
        <div id="navListWrap"><div class="doota_nav mu_nav_wrap"> <ul class="doota_ul"> <li><a class="menu_order disable-a"> 我的订单 </a> <ul class="mu_nav_item"> <li> <a href="orderlist.html#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6">全部订单</a> </li> <li> <a href="order_unshipped.html#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 待付款 <i id="unpaidOrder" class="mu_nav_count">2</i> </a> </li> <li class="c"> <a href="order_unshipped.html#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 待收货 <i id="unReceivedOrder" class="mu_nav_count"><i class="mu_nav_count_arw"></i></i> </a> </li> <li> <a href="order_received.html#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 待评价 <i id="waitingRateOrder" class="mu_nav_count"><i class="mu_nav_count_arw"></i></i> </a> </li> <li> <a href="order_DELETED.html#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 退货退款 <i class="mu_nav_count"><i class="mu_nav_count_arw"></i></i> </a> </li> <!-- 新增，stage=8 回收站订单 --> <li> <a href="order_DELETED.html#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 订单回收站 <i id="recyleOrder" class="mu_nav_count"><i class="mu_nav_count_arw"></i></i> </a> </li> </ul> </li> <li><a class="disable-a">优惠特权</a> <ul> <li><a class="menu_coupon_plat" href="coupon.html#?pages=1&amp;coupon_type=1&amp;status=0">平台优惠券</a></li> <li><a class="menu_coupon_shop" href="coupon.html#?pages=1&amp;coupon_type=2&amp;status=0">店铺优惠券</a></li> </ul> </li> <li> <a class="menu_pcenter" href="footprint.html#"> 我的足迹 <em class="little-triangle"></em><em class="little-triangle-hover"></em> </a> </li> <li> <a class="menu_pcenter" href="address.html#"> 收货地址 <em class="little-triangle"></em><em class="little-triangle-hover"></em> </a> </li> <li> <a class="disable-a">账号管理</a> <ul> <li><a href="setPersonal.html">我的信息</a></li> <li><a href="setAvatar.html#">个人头像</a></li> </ul> </li> <li> <a class="disable-a">安全中心</a> <ul> <li><a href="setPassword.html">用户密码</a></li> <li> <a href="payPassword.html">支付密码</a> </li> <li><a href="bindMobile.html">手机绑定</a></li> <li><a href="loginEqm.html#">登录设备</a></li> </ul> </li> </ul></div></div>
...
<script type="text/javascript" src="/homes/js/index.js-417ef0a2.js"></script>

<script type="text/javascript" src="/homes/js/index.js-800cd574.js"></script>

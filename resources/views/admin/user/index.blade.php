                ...
                @foreach($rs as $k => $v)
                    ...
                    @endif
                        ...
                        @php
                            switch($v->status){
                                case 0:
                                    echo '<td class=" ">未激活</td>';   
                                break;
                                case 1:
                                    echo '<td class=" ">普通用户</td>';   
                                break;
                                case 2:
                                    echo '<td class=" ">VIP用户</td>';   
                                break;
                            }
                        @endphp
                        ...
                        <td class=" ">
                            @php 
                                echo date('Y年m月d日h:i:s',$v->addtime); 
                            @endphp
                        </td>

                        <td class=" ">
                            &nbsp;&nbsp;&nbsp;&nbsp;
                               <a href="/admin/user/delete?id={{$v->id}}"class="icol-bin-closed" title="删除用户信息"></a>&nbsp;&nbsp;
                               <a href="/admin/userinfo" class="icol-sport-raquet" title="查看用户详细信息" style=""></a>&nbsp;&nbsp;
